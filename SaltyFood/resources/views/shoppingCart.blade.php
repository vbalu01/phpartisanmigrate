...
<head>
    ...
    <meta name="keywords" content="Salty, cart, foods">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="/shop" class="primary-btn cart-btn">Folytassa a vásárlást!</a>
                ...
                <div class="col-lg-6">
                    <div class="shoping__continue">
                        <div class="shoping__discount">
                            <h5>Kedvezményes kód</h5>
                            <form action="#">
                                <input type="text" placeholder="Írja be saltykupon kódját">
                                <button type="submit" class="site-btn">Alkalmaz</button>
                            </form>
                        </div>
                    </div>
                </div>
